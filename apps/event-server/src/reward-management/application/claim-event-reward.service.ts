...
} from '../../event-management/domain/user-event-progress/lookup-user-repository';
import { UserEventProgressRepository } from '../../event-management/domain/user-event-progress/user-event-progress.repository';
...
import { EventRewardClaimHistory } from '../../event-management/domain/event-reward-claim-history';
import { EventCondition } from '../../event-management/domain/event-condition';
import { ProgressStatus } from '../../event-management/domain/user-event-progress/progress-status';
import { RewardRepository } from '../domain/reward.repository';
import { REWARD_REPOSITORY } from '../domain/reward.repository';
import { RewardItemInfoViewModel } from '@app/common/view-model/reward-item-info.viewmodel';
@Injectable()
export class ClaimEventRewardService {
  constructor(
